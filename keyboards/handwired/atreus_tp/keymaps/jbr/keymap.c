...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [NORM] = {
    ...
    {TD(TD_FUNC),  KC_GRV,  OSM(MOD_LCTL),  KC_TAB,  KC_SPC,  GUI_T(KC_ESC),  KC_BSPC,  KC_ENT,  KC_NONUS_HASH,  KC_MINUS, TD(TD_SYM)}
  },
  [SHIFT] = {
  ...
  [SYM] = {
    ...
    {TO(NORM),      KC_NO,        KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_BSPC,          KC_TRNS,  KC_0,  KC_NO, KC_TRNS}
  },
  [FUNC] = {
